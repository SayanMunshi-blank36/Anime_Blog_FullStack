  ...
  return (
    <>
      ...
      <div className="container mx-auto p-8 flex flex-col items-center justify-center">
        <h1 className="font-bangers text-5xl text-center my-8 border-b-8 border-b-error">
          About Us
        </h1>
        <p className="mx-auto md:w-3/4 text-center font-montserrat text-xl mb-8">
        ...
        <h2 className="font-bangers text-4xl tracking-wider border-b-2 border-b-error w-fit">
          Follow Us On
        </h2>
        <div className="flex mt-4 mb-8">
          <BsTwitter className="text-4xl mx-4 hover:text-error cursor-pointer transition-all" />
          <BsReddit className="text-4xl mx-4 hover:text-error cursor-pointer transition-all" />
          <BsInstagram className="text-4xl mx-4 hover:text-error cursor-pointer transition-all" />
        </div>
      </div>
    </>
  );
